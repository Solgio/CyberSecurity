...
with open("/home/solgio/Downloads/partial1-2223/Irreversible Encryption/encrypted_flag.txt", "r") as f:
    a=f.read()

ascii_encrypted = binascii.unhexlify(a).decode('ascii')
xor_encrypted2 = XORencode(ascii_encrypted)

plain=xor_encrypted2
for _ in range(15):
    encrypted = ROTencode(plain, -3)
    b64_encrypted = base32decode(encrypted)
    b32_encrypted = ROTencode(b64_encrypted, -13)
    plain = base64decode(b32_encrypted)
